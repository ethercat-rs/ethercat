...
fn main() {
    if env::var("CARGO_FEATURE_PREGENERATED_BINDINGS").is_err() {
        ...
        let bindings = bindgen::Builder::default()
            ...
            .ignore_functions()
            .allowlist_type("ec_ioctl_.*")
            .allowlist_type("ec_master_state_t")
            .allowlist_var("EC_IOCTL_.*")
            .allowlist_var("EC_MAX_.*")
            .layout_tests(false)
            .generate()
