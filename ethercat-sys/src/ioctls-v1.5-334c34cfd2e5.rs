...
ioctl!(readwrite  EOE_HANDLER          with EC, 0x1d; ec_ioctl_eoe_handler_t);
ioctl!(none       REQUEST              with EC, 0x1e);
ioctl!(none       CREATE_DOMAIN        with EC, 0x1f);
ioctl!(readwrite  CREATE_SLAVE_CONFIG  with EC, 0x20; ec_ioctl_config_t);
ioctl!(write      SELECT_REF_CLOCK     with EC, 0x21; u32);
ioctl!(read       ACTIVATE             with EC, 0x22; ec_ioctl_master_activate_t);
ioctl!(none       DEACTIVATE           with EC, 0x23);
ioctl!(arg        SEND                 with EC, 0x24);
ioctl!(none       RECEIVE              with EC, 0x25);
ioctl!(read       MASTER_STATE         with EC, 0x26; ec_master_state_t);
ioctl!(readwrite  MASTER_LINK_STATE    with EC, 0x27; ec_ioctl_link_state_t);
ioctl!(write      APP_TIME             with EC, 0x28; u64);
ioctl!(none       SYNC_REF             with EC, 0x29);
ioctl!(write      SYNC_REF_TO          with EC, 0x2a; u64);
