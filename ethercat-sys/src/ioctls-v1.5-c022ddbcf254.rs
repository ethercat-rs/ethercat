...
ioctl!(readwrite  CONFIG               with EC, 0x18; ec_ioctl_config_t);
ioctl!(readwrite  CONFIG_PDO           with EC, 0x19; ec_ioctl_config_pdo_t);
ioctl!(readwrite  CONFIG_PDO_ENTRY     with EC, 0x1a; ec_ioctl_config_pdo_entry_t);
ioctl!(readwrite  CONFIG_SDO           with EC, 0x1b; ec_ioctl_config_sdo_t);
ioctl!(readwrite  CONFIG_IDN           with EC, 0x1c; ec_ioctl_config_idn_t);
ioctl!(readwrite  CONFIG_FLAG          with EC, 0x1d; ec_ioctl_config_flag_t);
...
ioctl!(write      SC_FLAG              with EC, 0x44; ec_ioctl_sc_flag_t);
ioctl!(arg        DOMAIN_SIZE          with EC, 0x45);
ioctl!(arg        DOMAIN_OFFSET        with EC, 0x46);
ioctl!(arg        DOMAIN_PROCESS       with EC, 0x47);
ioctl!(arg        DOMAIN_QUEUE         with EC, 0x48);
ioctl!(readwrite  DOMAIN_STATE         with EC, 0x49; ec_ioctl_domain_state_t);
ioctl!(readwrite  SDO_REQUEST_INDEX    with EC, 0x4a; ec_ioctl_sdo_request_t);
ioctl!(readwrite  SDO_REQUEST_TIMEOUT  with EC, 0x4b; ec_ioctl_sdo_request_t);
ioctl!(readwrite  SDO_REQUEST_STATE    with EC, 0x4c; ec_ioctl_sdo_request_t);
ioctl!(readwrite  SDO_REQUEST_READ     with EC, 0x4d; ec_ioctl_sdo_request_t);
ioctl!(readwrite  SDO_REQUEST_WRITE    with EC, 0x4e; ec_ioctl_sdo_request_t);
ioctl!(readwrite  SDO_REQUEST_DATA     with EC, 0x4f; ec_ioctl_sdo_request_t);
ioctl!(readwrite  REG_REQUEST_DATA     with EC, 0x50; ec_ioctl_reg_request_t);
ioctl!(readwrite  REG_REQUEST_STATE    with EC, 0x51; ec_ioctl_reg_request_t);
ioctl!(readwrite  REG_REQUEST_WRITE    with EC, 0x52; ec_ioctl_reg_request_t);
ioctl!(readwrite  REG_REQUEST_READ     with EC, 0x53; ec_ioctl_reg_request_t);
ioctl!(write      VOE_SEND_HEADER      with EC, 0x54; ec_ioctl_voe_t);
ioctl!(readwrite  VOE_REC_HEADER       with EC, 0x55; ec_ioctl_voe_t);
ioctl!(write      VOE_READ             with EC, 0x56; ec_ioctl_voe_t);
ioctl!(write      VOE_READ_NOSYNC      with EC, 0x57; ec_ioctl_voe_t);
ioctl!(readwrite  VOE_WRITE            with EC, 0x58; ec_ioctl_voe_t);
ioctl!(readwrite  VOE_EXEC             with EC, 0x59; ec_ioctl_voe_t);
ioctl!(readwrite  VOE_DATA             with EC, 0x5a; ec_ioctl_voe_t);
ioctl!(write      SET_SEND_INTERVAL    with EC, 0x5b; usize);
