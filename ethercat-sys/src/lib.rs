...
ioctl!(EC_IOCTL_MODULE,               0x00, rd, ec_ioctl_module_t);
ioctl!(EC_IOCTL_MASTER,               0x01, rd, ec_ioctl_master_t);
...
ioctl!(EC_IOCTL_SLAVE_STATE,          0x0b, wt, ec_ioctl_slave_state_t);
...
ioctl!(EC_IOCTL_SLAVE_SII_WRITE,      0x11, wt, ec_ioctl_slave_sii_t);
ioctl!(EC_IOCTL_SLAVE_REG_READ,       0x12, rw, ec_ioctl_slave_reg_t);
ioctl!(EC_IOCTL_SLAVE_REG_WRITE,      0x13, wt, ec_ioctl_slave_reg_t);
ioctl!(EC_IOCTL_SLAVE_FOE_READ,       0x14, rw, ec_ioctl_slave_foe_t);
ioctl!(EC_IOCTL_SLAVE_FOE_WRITE,      0x15, wt, ec_ioctl_slave_foe_t);
...
ioctl!(EC_IOCTL_SLAVE_EOE_IP_PARAM,   0x18, wt, ec_ioctl_slave_eoe_ip_t);
...
ioctl!(EC_IOCTL_SELECT_REF_CLOCK,     0x22, wt, u32);
ioctl!(EC_IOCTL_ACTIVATE,             0x23, rd, ec_ioctl_master_activate_t);
ioctl!(EC_IOCTL_DEACTIVATE,           0x24);
ioctl!(EC_IOCTL_SEND,                 0x25);
ioctl!(EC_IOCTL_RECEIVE,              0x26);
ioctl!(EC_IOCTL_MASTER_STATE,         0x27, rd, ec_master_state_t);
ioctl!(EC_IOCTL_MASTER_LINK_STATE,    0x28, rw, ec_ioctl_link_state_t);
ioctl!(EC_IOCTL_APP_TIME,             0x29, wt, ec_ioctl_app_time_t);
ioctl!(EC_IOCTL_SYNC_REF,             0x2a);
ioctl!(EC_IOCTL_SYNC_SLAVES,          0x2b);
ioctl!(EC_IOCTL_REF_CLOCK_TIME,       0x2c, rd, u32);
ioctl!(EC_IOCTL_SYNC_MON_QUEUE,       0x2d);
ioctl!(EC_IOCTL_SYNC_MON_PROCESS,     0x2e, rd, u32);
ioctl!(EC_IOCTL_RESET,                0x2f);
ioctl!(EC_IOCTL_SC_SYNC,              0x30, wt, ec_ioctl_config_t);
ioctl!(EC_IOCTL_SC_WATCHDOG,          0x31, wt, ec_ioctl_config_t);
ioctl!(EC_IOCTL_SC_ADD_PDO,           0x32, wt, ec_ioctl_config_pdo_t);
ioctl!(EC_IOCTL_SC_CLEAR_PDOS,        0x33, wt, ec_ioctl_config_pdo_t);
ioctl!(EC_IOCTL_SC_ADD_ENTRY,         0x34, wt, ec_ioctl_add_pdo_entry_t);
ioctl!(EC_IOCTL_SC_CLEAR_ENTRIES,     0x35, wt, ec_ioctl_config_pdo_t);
...
ioctl!(EC_IOCTL_SC_DC,                0x38, wt, ec_ioctl_config_t);
ioctl!(EC_IOCTL_SC_SDO,               0x39, wt, ec_ioctl_sc_sdo_t);
ioctl!(EC_IOCTL_SC_EMERG_SIZE,        0x3a, wt, ec_ioctl_sc_emerg_t);
ioctl!(EC_IOCTL_SC_EMERG_POP,         0x3b, rw, ec_ioctl_sc_emerg_t);
ioctl!(EC_IOCTL_SC_EMERG_CLEAR,       0x3c, wt, ec_ioctl_sc_emerg_t);
...
ioctl!(EC_IOCTL_SC_IDN,               0x42, wt, ec_ioctl_sc_idn_t);
...
ioctl!(EC_IOCTL_VOE_SEND_HEADER,      0x52, wt, ec_ioctl_voe_t);
ioctl!(EC_IOCTL_VOE_REC_HEADER,       0x53, rw, ec_ioctl_voe_t);
ioctl!(EC_IOCTL_VOE_READ,             0x54, wt, ec_ioctl_voe_t);
ioctl!(EC_IOCTL_VOE_READ_NOSYNC,      0x55, wt, ec_ioctl_voe_t);
...
ioctl!(EC_IOCTL_SET_SEND_INTERNAL,    0x59, wt, usize);
ioctl!(EC_IOCTL_SC_OVERLAPPING_IO,    0x5a, wt, ec_ioctl_config_t);
