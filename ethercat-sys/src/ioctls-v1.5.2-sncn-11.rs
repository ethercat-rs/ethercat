...
ioctl!(none       DEACTIVATE_SLAVES    with EC, 0x61);
...
ioctl!(none       EXEC_SLAVE_REQUESTS  with EC, 0x6c);
ioctl!(none       EOE_IS_OPEN          with EC, 0x6d);
ioctl!(none       EOE_PROCESS          with EC, 0x6e);
